...
export const IsometricDefs = () => (
    <defs>
      ...
      <radialGradient id="dbTop" cx="0.5" cy="0.5" r="0.5">
      ...
      <linearGradient id="aiCircuit" x1="0" y1="0" x2="1" y2="0">
...
export const IsometricServer = ({ size = 48, tech = 'default' }: IsoProps) => {
  ...
  return (
    <svg width={size} height={size * 1.3} viewBox="0 0 64 84" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M32 82L4 66L60 66L32 82Z" fill="black" fillOpacity="0.4" filter="blur(6px)"/>
      <g className="iso-breathing">
          ...
          <path d="M32 4 L60 20 L32 36 L4 20 Z" fill="white" fillOpacity="0.2" stroke="white" strokeWidth="0.5" strokeOpacity="0.5"/>
      </g>
      {/* Front Panel */}
...
export const IsometricDB = ({ size = 48, tech = 'default' }: IsoProps) => {
  ...
  return (
    <svg width={size} height={size * 1.2} viewBox="0 0 64 76" fill="none">
      <ellipse cx="32" cy="68" rx="26" ry="8" fill="black" fillOpacity="0.3" filter="blur(5px)" />
      ...
      <g className="iso-breathing">
          ...
          <path d="M4 36 C4 46 16.5 54 32 54 C47.5 54 60 46 60 36" stroke={strokeColor} strokeWidth="1" strokeOpacity="0.4" fill="none"/>
          <path d="M4 37 C4 47 16.5 55 32 55 C47.5 55 60 47 60 37" stroke="white" strokeWidth="1" strokeOpacity="0.2" fill="none"/>
          <ellipse cx="32" cy="24" rx="28" ry="14" fill={topColor} stroke={strokeColor} strokeWidth="0.5" />
          <ellipse cx="32" cy="24" rx="24" ry="10" stroke="white" strokeWidth="2" strokeOpacity="0.4" fill="none" className="iso-glowing"/>
      </g>
    </svg>
  );
};
...
export const IsometricCloud = ({ size = 48 }: IsoProps) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
     <g className="iso-floating">
        <ellipse cx="32" cy="52" rx="24" ry="8" fill="black" fillOpacity="0.2" filter="blur(6px)" />
        <path d="M16 42 L16 32 L32 22 L32 32 Z" fill="#67e8f9" />
        <path d="M16 42 L32 52 L32 32 L16 32 Z" fill="#06b6d4" />
        <path d="M32 22 L32 42 L48 52 L48 32 Z" fill="#0891b2" />
        <path d="M16 32 L32 22 L48 32 L32 42 Z" fill="url(#cloudGrad)" className="iso-glowing" />
     </g>
  </svg>
);
...
export const IsometricAI = ({ size = 48 }: IsoProps) => (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
        <g className="iso-floating">
             ...
             {/* Circuit Lines */}
             <path d="M26 34 L32 37 L38 34" stroke="url(#aiCircuit)" strokeWidth="1.5" />
             <path d="M20 38 L26 41" stroke="url(#aiCircuit)" strokeWidth="1.5" />
             <path d="M38 41 L44 38" stroke="url(#aiCircuit)" strokeWidth="1.5" />
             <path d="M32 43 L32 48" stroke="url(#aiCircuit)" strokeWidth="1.5" />

             {/* Glowing Core */}
             <circle cx="32" cy="40" r="3" fill="url(#aiCircuit)" className="iso-pulsing-1" filter="drop-shadow(0 0 4px #d946ef)" />
             <path d="M32 40 L32 20" stroke="#a855f7" strokeWidth="1" strokeDasharray="2 2" className="iso-glowing" opacity="0.5"/>
             <circle cx="32" cy="20" r="2" fill="#d8b4fe" className="iso-pulsing-2" />
        </g>
    </svg>
);
